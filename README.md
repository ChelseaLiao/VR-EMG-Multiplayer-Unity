...
1. Body language from player in VR as the commands to player with EMG sensor, e.g. pointing to somewhere for teleportation, holding arms for slowing down time
2. Light color in VR representing the ongoing skill: blue - teleporting, yellow - slowing down time and red - punching
